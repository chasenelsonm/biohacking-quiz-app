...
const quizService = __importStar(require("../services/localstackService")); // Import the quiz service
const router = (0, express_1.Router)();
const quizController = new quizController_1.default(quizService); // Pass the quizService to the constructor
